...
3️⃣ List All Movies Released in a Specific Year (e.g., 2019)
```sql
SELECT * 
FROM netflix
...
🔟 Find the Average Number of Content Added from India Each Year
```sql
SELECT  
...
✅ Top 5 Directors with the Most Content in India
...
✅ Top 10 Actors Who Appeared in Most Indian Movies
...
✅ Categorizing Content as 'Good' or 'Bad' Based on Keywords
...
📌 Conclusion
This SQL project provides valuable insights into Netflix content, helping businesses understand viewing trends, popular genres, and content distribution across regions. 🚀
